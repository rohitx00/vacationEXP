      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              ...
              Here is your expedition command center.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-card border border-border p-6 rounded-xl">
            <div className="text-muted-foreground text-sm font-mono mb-2 uppercase">
              Saved Trips
            </div>
        ...
        <div className="pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {trips.length === 0 ? (
                ...
                trips.map((trip) => (
                  <div
                    key={trip._id}
                    className="bg-card border border-border p-6 rounded-xl space-y-4 hover:shadow-md transition-shadow cursor-pointer"
          ...
          {activeTab === "posts" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {posts.length === 0 ? (
                <p className="text-muted-foreground">
                  You haven't published any dispatches yet.
                </p>
              ) : (
                posts.map((post) => (
                  <div
                    key={post._id}
                    className="bg-card border border-border overflow-hidden rounded-xl group cursor-pointer hover:shadow-md transition-all"
                  ...
                  >
                    ...
                    <div className="p-6 space-y-3">
                      ...
                      <div className="flex items-center gap-4 text-muted-foreground text-sm">
                        ...
                        <span className="flex items-center gap-1">
                          <FileText size={14} /> {post.comments.length}
                        </span>
                      </div>
                    </div>
                  </div>
